...
const AppRouter = () => {
  return (
      ...
      <Routes>
        ...
        <Route path="/trail/:levelNumber/:questionIndex" element={<TrailRetriveid />} />
        <Route path="/trailUpdate/:levelNumber/:questionIndex" element={<TrailUpdate />} />
        <Route path="/PlayerList" element={<PlayerList />} />
        <Route path="/playerId/:playerId" element={<PlayerId />} />
        <Route path="/QRScanner" element={<QRScanner />} />
        <Route path="/startgame/:playerId" element={<StartGame />} />
        <Route path="/QrGenerate/:levelNumber/:questionIndex" element={<QrGenerate />} />
